...
function App() {
  ...
  return (
    <main>
      <h1>IKIMINA BLOCKCHAIN BASED SYSTEM</h1>
      {isLoggedIn ? (
        <>
          
          <button onClick={signOut}>Sign Out</button>
          <button onClick={() => setShowAddCustomerForm(true)}>CREATE ACCOUNT</button>
          <button onClick={handleViewCustomers}>LOGIN</button>
          ...
          {showAddCustomerForm && (
            <form onSubmit={handleAddCustomer}>
              ...
              <button type="submit">Click here to Register Account </button>
            </form>
          )}
